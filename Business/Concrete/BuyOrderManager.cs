...
namespace Business.Concrete
{
    public class BuyOrderManager : IBuyOrderService
    {
        ...
        public BuyOrderManager(IBuyOrderDal buyOrderDal, IParityDal parityDal, IUserDal userDal, ITokenHelper tokenHelper, IWalletDal walletDal, ISalesOrderDal salesOrderDal, ICompanyWalletDal companyWalletDal)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                BuyOrder buyorderAdd = new BuyOrder();
                {
                    ...
                    foreach (var sellOrder in sellOrders)
                    {
                        ...
                        {
                            buyorderAdd.SellerId = 0;
                            buyorderAdd.SellerOrderId = 0;
                        }
                    }
        ...
        public IDataResult<List<BuyOrderListDto>> BuyOrderGetList(BuyOrderGetListFilterDto buyOrderGetListFilterDto)
        {
            try
            {
                // if şartının farklı bir kullanımı
                buyOrderGetListFilterDto.PagingFilter.PageNumber = buyOrderGetListFilterDto.PagingFilter.PageNumber >= 0 ? buyOrderGetListFilterDto.PagingFilter.PageNumber : 1;
                buyOrderGetListFilterDto.PagingFilter.PageSize = buyOrderGetListFilterDto.PagingFilter.PageSize >= 0 ? buyOrderGetListFilterDto.PagingFilter.PageSize : 10;
        ...
        public IDataResult<List<BuyOrderListDto>> UserBuyOrderList(UserGetBuyOrderListFilterDto userGetBuyOrderListFilterDto)
        {
            try
            {
                userGetBuyOrderListFilterDto.PagingFilter.PageNumber = userGetBuyOrderListFilterDto.PagingFilter.PageNumber >= 0 ? userGetBuyOrderListFilterDto.PagingFilter.PageNumber : 1;
                userGetBuyOrderListFilterDto.PagingFilter.PageSize = userGetBuyOrderListFilterDto.PagingFilter.PageSize >= 0 ? userGetBuyOrderListFilterDto.PagingFilter.PageSize : 10;
