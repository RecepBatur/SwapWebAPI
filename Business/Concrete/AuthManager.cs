...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public AuthManager(IUserService userService, ITokenHelper tokenHelper, IUserOperationClaimService userOperationClaimService, IWalletService walletService, IUserDal userDal, IOperationClaimDal operationClaimDal, IUserOperationClaimDal userOperationClaimDal, ICoinDal coinDal, IWalletDal walletDal)
        {
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password)
        {
            ...
            var member = _operationClaimDal.Get(x => x.Name == "Member");
            if (member != null)
            {
