...
{
    public class AdminSalesOrderManager : ISalesOrderService
    {
        ...
        public AdminSalesOrderManager(ISalesOrderDal salesOrderDal, IBuyOrderDal buyOrderDal, IUserDal userDal, IWalletDal walletDal, ICompanyWalletDal companyWalletDal, IParityDal parityDal, ITokenHelper tokenHelper)
        {
