...
{
    public class AdminUserOperationClaimManager : IUserOperationClaimService
    {
        private readonly IUserOperationClaimDal _userOperationClaimDal;

        public AdminUserOperationClaimManager(IUserOperationClaimDal userOperationClaimDal)
        {
