...
builder.Services.AddCors(options =>
{
    ...
    options.AddPolicy("AllowOrigin",
        configurePolicy: builder => builder.WithOrigins("http://localhost:7032")); //origin istek yapýlan yer demek.
});
...
app.UseCors(builder => builder.WithOrigins("http://localhost:7032").AllowAnyHeader());
